...
# Add laravel queue service
RUN mkdir                                                               /etc/service/laravel-queue
ADD build/laravel-queue/run.sh                                          /etc/service/laravel-queue/run
RUN chmod +x                                                            /etc/service/laravel-queue/run
